...
module Stern
  RSpec.describe ChargeManual, type: :model do
    ...
    describe "#call" do
      ...
      it "writes four entry pairs (pay_manual + pp_charge_manual + pp_charge + customer pair)" do
      ...
      it "keeps BRL and USD balances fully independent for the same payment" do
        ...
        brl = ::Stern.balance(payment_id, :payment_manual, :BRL)
        usd = ::Stern.balance(payment_id, :payment_manual, :USD)

...
module Stern
  RSpec.describe ChargeWallet, type: :model do
    ...
    describe "#call" do
      ...
      it "writes four entry pairs (pay_wallet + pp_charge_wallet + pp_charge + customer pair)" do
      ...
      it "keeps BRL and USD balances fully independent for the same payment" do
        ...
        brl = ::Stern.balance(payment_id, :payment_wallet, :BRL)
        usd = ::Stern.balance(payment_id, :payment_wallet, :USD)

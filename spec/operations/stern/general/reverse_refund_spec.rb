...
module Stern
  RSpec.describe ReverseRefund, type: :model do
    ...
    describe "#target_tuples" do
      it "merchant: pins customer_available@customer_id and merchant_available@merchant_id" do
      ...
      it "partner: pins customer_available@customer_id and partner_available@partner_id" do
    ...
    describe "#call" do
      ...
      it "moves balance from customer_available back to merchant_available" do
      ...
      it "moves balance back to partner_available for partner-funded refunds" do
      ...
      it "writes one entry pair (reverse_refund_merchant) keyed by customer_id" do
        settle_refund({ merchant_id: }, amount: 700)
      ...
      it "supports partial reversal: reversing 300 of 700 leaves 400 with the customer" do
        settle_refund({ merchant_id: }, amount: 700)
      ...
      it "raises InsufficientFunds when amount exceeds customer balance" do
      ...
      it "with allow_overdraft: true, succeeds and pushes the customer negative" do
        settle_refund({ merchant_id: }, amount: 100)

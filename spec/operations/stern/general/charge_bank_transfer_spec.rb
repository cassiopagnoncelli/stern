...
module Stern
  RSpec.describe ChargeBankTransfer, type: :model do
    ...
    describe "#call" do
      ...
      it "writes four entry pairs (pay_bank_transfer + pp_charge_bank_transfer + pp_charge + customer pair)" do
      ...
      it "keeps BRL and USD balances fully independent for the same payment" do
        ...
        brl = ::Stern.balance(payment_id, :payment_bank_transfer, :BRL)
        usd = ::Stern.balance(payment_id, :payment_bank_transfer, :USD)

...
module Stern
  RSpec.describe ChargeDebitCard, type: :model do
    ...
    describe "#call" do
      ...
      it "writes four entry pairs (pay_debit_card + pp_charge_debit_card + pp_charge + customer pair)" do
      ...
      it "keeps BRL and USD balances fully independent for the same payment" do
        ...
        brl = ::Stern.balance(payment_id, :payment_debit_card, :BRL)
        usd = ::Stern.balance(payment_id, :payment_debit_card, :USD)

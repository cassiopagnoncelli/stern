...
module Stern
  RSpec.describe ChargeInternal, type: :model do
    ...
    describe "#call" do
      ...
      it "writes four entry pairs (pay_internal + pp_charge_internal + pp_charge + customer pair)" do
      ...
      it "keeps BRL and USD balances fully independent for the same payment" do
        ...
        brl = ::Stern.balance(payment_id, :payment_internal, :BRL)
        usd = ::Stern.balance(payment_id, :payment_internal, :USD)

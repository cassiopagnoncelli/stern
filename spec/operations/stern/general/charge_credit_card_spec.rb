...
module Stern
  RSpec.describe ChargeCreditCard, type: :model do
    ...
    describe "#call" do
      ...
      it "writes four entry pairs (pay_credit_card + pp_charge_credit_card + pp_charge + customer pair)" do
      ...
      it "keeps BRL and USD balances fully independent for the same payment" do
        ...
        brl = ::Stern.balance(payment_id, :payment_credit_card, :BRL)
        usd = ::Stern.balance(payment_id, :payment_credit_card, :USD)

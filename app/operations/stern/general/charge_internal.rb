...
module Stern
  class ChargeInternal < BaseOperation
    ...
    def target_tuples
      tuples = tuples_for_pair(:pay_internal, charge_id, currency)
      tuples = tuples_for_pair(:pp_charge_internal, customer_id, currency)
    ...
    def perform(operation_id)
      ...
      EntryPair.add_pay_internal(charge_id, payment_id, amount, currency, operation_id:)

      # Accounting info pairs.
      EntryPair.add_pp_charge_internal(charge_id, payment_id, amount, currency, operation_id:)

...
module Stern
  class ChargeWallet < BaseOperation
    ...
    def target_tuples
      tuples = tuples_for_pair(:pay_wallet, charge_id, currency)
      tuples = tuples_for_pair(:pp_charge_wallet, customer_id, currency)
    ...
    def perform(operation_id)
      ...
      EntryPair.add_pay_wallet(charge_id, payment_id, amount, currency, operation_id:)

      # Accounting info pairs.
      EntryPair.add_pp_charge_wallet(charge_id, payment_id, amount, currency, operation_id:)

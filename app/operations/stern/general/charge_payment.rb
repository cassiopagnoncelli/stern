...
module Stern
  class ChargePayment < BaseOperation
    ...
    inputs :payment_id, :payment_method, :amount, :currency
    ...
    def target_tuples
      tuples_for_pair("charge_#{payment_method}".to_sym, payment_id, payment_id, currency)
    end

    def perform(operation_id)
      EntryPair.public_send("add_charge_#{payment_method}".to_sym, payment_id, payment_id, amount, currency, operation_id:)
    end
  end
end

...
module Stern
  class ChargeBankTransfer < BaseOperation
    ...
    def target_tuples
      tuples = tuples_for_pair(:pay_bank_transfer, charge_id, currency)
      tuples = tuples_for_pair(:pp_charge_bank_transfer, customer_id, currency)
    ...
    def perform(operation_id)
      ...
      EntryPair.add_pay_bank_transfer(charge_id, payment_id, amount, currency, operation_id:)

      # Accounting info pairs.
      EntryPair.add_pp_charge_bank_transfer(charge_id, payment_id, amount, currency, operation_id:)

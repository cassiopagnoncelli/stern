...
module Stern
  class ChargeCreditCard < BaseOperation
    ...
    def target_tuples
      tuples = tuples_for_pair(:pay_credit_card, charge_id, currency)
      tuples = tuples_for_pair(:pp_charge_credit_card, customer_id, currency)
    ...
    def perform(operation_id)
      ...
      EntryPair.add_pay_credit_card(charge_id, payment_id, amount, currency, operation_id:)

      # Accounting info pairs.
      EntryPair.add_pp_charge_credit_card(charge_id, payment_id, amount, currency, operation_id:)

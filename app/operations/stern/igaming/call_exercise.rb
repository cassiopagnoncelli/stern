...
module Stern
  ...
  class CallExercise < BaseOperation
    ...
    def perform(operation_id)
      ...
      EntryPair.add_payout_call_usd(call_option_id, customer_id, amount, nil, operation_id:) if amount.present?
      EntryPair.add_bops_trade_pl_usd(call_option_id, customer_id, amount, nil, operation_id:) if amount.present?
    end

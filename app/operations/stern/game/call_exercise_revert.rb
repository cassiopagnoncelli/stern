...
module Stern
  ...
  class CallExerciseRevert < BaseOperation
    ...
    def perform(operation_id)
      ...
      EntryPair.add_payout_call_revert_usd(call_option_id, customer_id, payout, nil, operation_id:) if payout.present?
      EntryPair.add_bops_trade_pl_revert_usd(call_option_id, customer_id, payout, nil, operation_id:) if payout.present?
    end

...
module Stern
  ...
  class PutExercise < BaseOperation
    ...
    def perform(operation_id)
      ...
      EntryPair.add_payout_put_usd(put_option_id, customer_id, amount, nil, operation_id:) if amount.present?
      EntryPair.add_bops_trade_pl_usd(put_option_id, customer_id, amount, nil, operation_id:) if amount.present?
    end
